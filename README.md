# Switchback Example Classic


This applicaiton uses standard react-redux application created from CRA. When running the app open the developer 
tools (F12) to view the console log.
